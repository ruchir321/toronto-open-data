...
def generate_wordcloud():
    """
    Generates a word cloud from the 'description' column of the cleaned_events.csv file.
    """
    ...
    # Save the word cloud
    wordcloud.to_file("output/events/events_wordcloud.png")
    print("Word cloud saved to output/events/events_wordcloud.png")
